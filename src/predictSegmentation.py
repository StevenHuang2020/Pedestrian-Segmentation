...
import numpy as np
import argparse
from commonModule.ImageBase import blurImg, resizeImg, getImgHW, getImagChannel
from commonModule.ImageBase import gaussianBlurImg, grayImg, loadImg, loadGrayImg
...
def getPredictImg(img):
    return getPredictionMaskImg(img.copy())
